        ...
        <div className="p-2">
          <div className="relative">
            <input
              type="text"
              placeholder="Help..."
              className="w-full pl-8 pr-4 py-2 bg-gray-100 rounded-md text-sm"
        ...
        {menuItems.map((item, index) => (
          <div key={index}>
            <button
              ...
              className={`w-full text-left flex items-center gap-3 px-4 py-2 text-gray-700 hover:bg-gray-100 ${
                isCollapsed ? 'justify-center' : ''
              } ${isInSection(item.path) ? 'bg-gray-50' : ''} ${
